...
export function ProductCard({
  ...
  return (
    <Card className="overflow-hidden border border-neutral-200 hover:border-blue-400 transition-all h-full flex flex-col">
      <div className="relative p-4 bg-white flex-grow flex flex-col">
        ...
        <div className={`grid ${showAddToCart ? 'grid-cols-2 gap-2' : 'grid-cols-1'}`}>
          {onButtonClick ? (
            ...
            <Link href={`/products/${category?.toLowerCase() || 'all'}/${id}`} className="w-full">
